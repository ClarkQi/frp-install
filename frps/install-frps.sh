...
program_version_link="https://raw.githubusercontent.com/ClarkQi/frp-install/main/frps/version.sh"
str_install_shell=https://raw.githubusercontent.com/ClarkQi/frp-install/main/frps/install-frps.sh
shell_update(){
    fun_clangcn "clear"
